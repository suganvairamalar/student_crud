   $( document ).ready(function() {
            ...
            $("#edit_dob").datepicker({
                onSelect: function (value, ui) {
                    var today = new Date();
                    edit_age = today.getFullYear() - ui.selectedYear;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        var editdob=$.datepicker.formatDate( "dd-mm-yy", new Date(res.data.dob));
                        $('#edit_dob').val(editdob);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        var viewdob=$.datepicker.formatDate( "dd-mm-yy", new Date(res.data.dob));
                        $('#view_dob').text(viewdob);
